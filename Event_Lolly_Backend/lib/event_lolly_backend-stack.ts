...
export class EventLollyBackendStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    mutations.forEach((mut) => {
      ...
      if (mut === "addLolly") {
        let details = `\\\"flavourTop\\\": \\\"$ctx.arguments.flavourTop\\\",\\\"flavourMiddle\\\": \\\"$ctx.arguments.flavourMiddle\\\",\\\"flavourBottom\\\": \\\"$ctx.arguments.flavourBottom\\\",\\\"message\\\": \\\"$ctx.arguments.message\\\",\\\"recipientName\\\": \\\"$ctx.arguments.recipientName\\\",\\\"senderName\\\": \\\"$ctx.arguments.senderName\\\"`
